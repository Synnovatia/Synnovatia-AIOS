...
Usage:
    python scripts/content_pipeline/context_aggregator.py              # Print context summary
    python scripts/content_pipeline/context_aggregator.py --full       # Print full formatted context
...
if __name__ == "__main__":
    if not DB_PATH.exists():
        ...
        print("Run 'python scripts/content_pipeline/db.py' first to initialize.")
        sys.exit(1)
