...
Determine:
- **Channel:** linkedin or blog (from strategy.md)
- **Format:** Appropriate format for that channel (from strategy.md format types — e.g. `post` for LinkedIn, `article` for blog)
- **Content pillar:** Which of their defined pillars this falls under (thought leadership / story / client win / SEO-search)
...
from scripts.content_pipeline.db import get_connection
from scripts.content_pipeline.writer import write_content_idea
