...
| Re-engage former clients | Weekly (draft Mon 7am, send Tue) | TBD | High | **Built** (2026-07-20) | System migrated 2026-07-11: `client-reengagement/` — 176-client roster, 6-month cadence, Gmail draft generation, opportunity tracking. Drafting automated 2026-07-20 via `client-reengagement-monday-drafting` (Mondays 7am): checks Gmail for replies to prior batches, refreshes the due list, drafts 5 emails oldest-overdue first. Draft-only — Jackie reviews Monday, sends Tuesday. 151 currently due (~30 weeks at 5/week); 10 sends awaiting a reply check; 1 opportunity flagged (Ginny Kenyon) |
...
| Task | Frequency | Est. Time | Automation Potential | Status | Notes |
|---|---|---|---|---|---|
| Grow Messy Middle membership | New | TBD | Medium | **In Progress** (plan written 2026-07-13, execution started 2026-07-19) | Currently 4 real members (Elise, Wilma, Amy, Sandra) + Jackie. Women-only group, $250K-$500K band. Full plan: `plans/2026-07-13-messy-middle-growth.md` — 3 channels (HubSpot 397 segment, LinkedIn, re-engagement roster mining), targeting 3-5 new by Oct 2026. Channel 1 (HubSpot) progress: dedicated-push email sent 2026-07-15; standalone deadline-driven invitation drafted 2026-07-19 (`outputs/hubspot-marketing/2026-07-19-messy-middle-standalone-invitation.md`), awaiting Jackie's send-date/deadline confirmation. Channels 2 (LinkedIn) and 3 (roster mining) not yet started. |
