...
> This file captures your current priorities, goals, and direction. Claude reads this to understand what you're working toward and what success looks like.

---

## How This Connects

- **business-info.md** provides the organizational context
- **personal-info.md** defines your role
- **This file** captures where you're trying to go
- **current-data.md** shows where you currently stand
...
- Setting up this AI workspace (EVOLV-OS) to support both the business (client prospecting, former-client re-engagement, invoicing/bookkeeping) and personal life (planning, logistics), given the real constraint of ~20 hrs/week spent in school
- Whether/when to bring in another consultant to serve the $250K–$500K segment, so Jackie can focus on higher-level strategy clients and business development
...
_Update this file when priorities shift. Stale strategy = stale AI._
